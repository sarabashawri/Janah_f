  ...
  void _callGuardian() {
    ...
    if (phone.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('الرجاء إدخال رقم الجوال أولاً'), backgroundColor: Colors.red),
      );
      return;
    }
    // فتح الاتصال
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // ── بيانات الطفل المفقود ──
                      _buildCard(
                        icon: Icons.person_outline,
                        title: 'بيانات الطفل المفقود',
                        children: [
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton.icon(
                              ...
                              label: const Text('الاتصال بولي الأمر', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: Colors.white)),
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton.icon(
                          ...
                          label: Text(
                            _isLoading ? 'جاري الإرسال...' : 'رفع البلاغ',
                      ...
                      SizedBox(
                        ...
                        child: OutlinedButton(
                          ...
                          child: const Text('إلغاء', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600, color: kPrimary)),
                        ),
                      ),
                      const SizedBox(height: 24),
                    ],

        ...
        body: SafeArea(
          child: Column(
            children: [
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    const Expanded(
                      child: Text('التحقق من النتائج', textAlign: TextAlign.center,
              ...
              Expanded(
                child: widget.reportId.isEmpty
                    ? const Center(child: Text('لا توجد بيانات', style: TextStyle(color: Color(0xFF9E9E9E))))
                            ...
                            child: Column(
                              children: [
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        decoration: BoxDecoration(color: const Color(0xFFFFB300), borderRadius: BorderRadius.circular(20)),
                                        child: const Text('قيد المراجعة', style: TextStyle(fontSize: 11, fontWeight: FontWeight.w700, color: Colors.white)),
                                      ),
                                    ],
                                  ),
                                ),
                                          ...
                                          Expanded(
                                            child: Column(
                                              children: [
                                                ...
                                                const Text('صورة الطفل الأصلية', style: TextStyle(fontSize: 10, color: Color(0xFF9E9E9E)), textAlign: TextAlign.center),
                                              ],
                                            ),
                                          ),
                                          ...
                                          Expanded(
                                            child: Column(
                                              children: [
                                                ...
                                                const SizedBox(height: 6),
                                                const Text('جناح', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w700), textAlign: TextAlign.center),
                                                const Text('لقطة من الدرون', style: TextStyle(fontSize: 10, color: Color(0xFF9E9E9E)), textAlign: TextAlign.center),
                                              ],
                                            ),
                                          ),
                                        ],
                                ...
                                Container(
                                  padding: const EdgeInsets.all(16),
                                  decoration: BoxDecoration(
                                    color: const Color(0xFFE8FFF5), borderRadius: BorderRadius.circular(16),
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: const Row(children: [
                                          ...
                                          SizedBox(width: 8),
                                          Expanded(child: Text('النظام يوصي بـ "تطابق" بناءً على التحليل. يرجى المراجعة والتأكيد.', style: TextStyle(fontSize: 11, color: Color(0xFF2E7D32)))),
                                        ]),
                                      ),
                                    ],
                                  ),
                                ...
                                Container(
                                  ...
                                  child: const Row(children: [
                                    ...
                                    SizedBox(width: 8),
                                    Expanded(child: Text('تأكد من دقة قرارك. سيتم إرسال إشعار فوري لولي الأمر في حالة التطابق.', style: TextStyle(fontSize: 12, color: Color(0xFF5D4037)))),
                                  ]),
                                ),
